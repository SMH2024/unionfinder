...
export const metadata = {
  title: 'Pricing',
  description:
    'Companies all over the world have closed millions of deals with Unionbook. Sign up today and start selling smarter.',
}
...
const tiers = [
  {
    ...
    highlights: [
      ...
      { description: 'UnionbookAI integrations', disabled: true },
  ...
  },
  {
    ...
    highlights: [
      ...
      { description: 'UnionbookAI integrations' },
  ...
  return (
    <Container className="mt-16">
      ...
      <Lead className="mt-6 max-w-3xl">
        Companies all over the world have closed millions of deals with Unionbook.
            ...
            <figure className="mx-auto flex max-w-xl flex-col gap-16 max-lg:text-center">
              <blockquote>
                <p className="relative text-3xl tracking-tight text-white before:absolute before:-translate-x-full before:content-['“'] after:absolute after:content-['”'] lg:text-4xl">
                  Thanks to Unionbook, we&apos;re finding new leads that we never
